...
def test_login_positive(driver_login):
    ...
    edoc_title = wait_xpath(xpath='//*[@id="root"]/header/div/div[1]/div/p')
...
def test_login_negative_wrong(driver_login):
    ...
    error_login = wait_xpath(xpath='//*[@id="root"]/div/div/div[2]/p')
...
def test_login_negative_empty_username(driver_login):
    ...
    username_required = wait_xpath(xpath='//*[@id=":r0:-helper-text"]')
...
def test_login_negative_empty_pass(driver_login):
    ...
    password_required = wait_xpath(xpath='//*[@id=":r1:-helper-text"]')
